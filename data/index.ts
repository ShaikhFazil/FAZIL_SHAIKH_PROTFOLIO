...
const data = {
  home: {
    name: "Fazil Shaikh",
    description: "I Fix, Optimize & Build #Next_js & #React Website", // # -> for css style, _ -> create space, __ -> creates dash
    cvLink: "#contact",
  },
  sidebar: {
    links: [
  ...
  projects: {
    projects: [
      ...
      {
        id: 2,
        title: "Pets Alley - PET SHOP",
        description:
          "Built key features for Petsallet, a pet shop e-commerce platform that allows users to explore and purchase pet food, medicines, and other pet care essentials.\n\nTechnologies Used: React.js, Node.js, MongoDB, Express, Tailwind CSS.",
      },

      {
        id: 3,
        title: "Trends of media",
        description:
          "Developed the official static website for Trends of Media®, a premium digital marketing and creative agency helping founders, startups, and global brands grow through branding, website development, social media marketing, performance marketing, mobile app development, and creative production.",
      },

      {
        ...
        description:
          "Developed a responsive business website for Barkat Dry Fruits, an online store offering premium quality dry fruits, nuts, and healthy snacks. \n\nTechnologies Used: React.js, Tailwind CSS, MongoDB.",
      },
